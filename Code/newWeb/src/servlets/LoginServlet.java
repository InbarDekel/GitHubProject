...
public class LoginServlet extends HttpServlet {
    ...
    private final String SIGN_UP_URL = "/pages/sign/sign.html";
    private final String LOGIN_ERROR_URL = "/pages/sign/loginerror/error.jsp";  // must start with '/' since will be used in request dispatcher...
     /**
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                       ...
                       // getServletContext().getRequestDispatcher(LOGIN_ERROR_URL).forward(request, response);
                        ...
                        response.sendRedirect(ALLREP_ROOM_URL);
